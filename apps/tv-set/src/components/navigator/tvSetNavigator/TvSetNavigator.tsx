...
export const TvSetNavigator: React.FC<any> = ({
	...
	const [globalTouchDetection, setGlobalTouchDetection] = useState<boolean>(true);
	...
	const {
		...
		keyDownHandler,
		keyUpHandler,
	} = useTvKeyHandlers(nextChannel, prevChannel, changeChannel, setChannelMeta, buttonAudioRef);
