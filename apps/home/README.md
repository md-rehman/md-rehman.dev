...
![Companion App Preview](public/images/companion.png)

### TV Set App Preview
![TV Set App Preview](public/images/tv-set.png)

### Planner App Preview
![Planner App Preview](public/images/planner.png)

## Tech Stack
- **Framework:** Next.js (v16+)
- **Library:** React 19
- **Language:** TypeScript
- **Styling:** Shared UI package (`@repo/ui`)
